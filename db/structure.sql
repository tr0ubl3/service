...
CREATE TABLE "events" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "machine_id" integer, "event_date" date, "event_type" varchar(255), "event_description" text, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
